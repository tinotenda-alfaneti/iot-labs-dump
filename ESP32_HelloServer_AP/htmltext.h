...
String webcode(int LEDG, int LEDR, int LEDB, int counter)
{
  ...
  if(LEDB>0)
  {
    page +="<td>Blue LED is ON now";
    page +="<a href='/LEDBurl' class='btn on' >";
    page +="Press to turn Blue LED OFF</a></td>";
} else {
    page +="<td>Blue LED is OFF now";
    page +="<a href='/LEDBurl' class='btn off'>";
    page +="Press to turn Blue LED ON</a></td>";
  }
  page +="</tr></table>";
